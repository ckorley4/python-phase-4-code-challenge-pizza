...
with app.app_context():
    ...
    pr1 = RestaurantPizza(restaurant_id=1, pizza_id=1, price=1)
    pr2 = RestaurantPizza(restaurant_id=2, pizza_id=2, price=4)
    pr3 = RestaurantPizza(restaurant_id=3, pizza_id=3, price=5)
